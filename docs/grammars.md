...
A grammar defines how source code is tokenized for a particular language. Smalto ships with 29 built-in grammars and supports custom grammar definitions.
