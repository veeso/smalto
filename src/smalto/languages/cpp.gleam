...
fn rules() -> List(Rule) {
  [
    ...
    grammar.greedy_rule_with_inside(
      ...
      [
        ...
        grammar.rule_with_inside("expression", "\\S[\\s\\S]*", [
          ...
          grammar.greedy_rule_with_inside(
            "base-clause",
            "(?:\\b(?:class|struct)\\s+\\w+\\s*:\\s*)\\K[^;{}\"'\\s]+(?:\\s+[^;{}\"'\\s]+)*(?=\\s*[;{])",
            [
              grammar.greedy_rule(
                "comment",
                "\\/\\/(?:[^\\r\\n\\\\]|\\\\(?:\\r\\n?|\\n|(?![\\r\\n])))*|\\/\\*[\\s\\S]*?(?:\\*\\/|$)",
              ...
              grammar.greedy_rule_with_inside(
                ...
                [
                  ...
                  grammar.rule_with_inside("expression", "\\S[\\s\\S]*", [
                    ...
                    grammar.rule(
                      "class-name",
                      "(?:\\b(?:class|concept|enum|struct|typename)\\s+)\\K(?!\\b(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char16_t|char32_t|char8_t|class|co_await|co_return|co_yield|compl|concept|const|const_cast|consteval|constexpr|constinit|continue|decltype|default|delete|do|double|dynamic_cast|else|enum|explicit|export|extern|final|float|for|friend|goto|if|import|inline|int|int16_t|int32_t|int64_t|int8_t|long|module|mutable|namespace|new|noexcept|nullptr|operator|override|private|protected|public|register|reinterpret_cast|requires|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template|this|thread_local|throw|try|typedef|typeid|typename|uint16_t|uint32_t|uint64_t|uint8_t|union|unsigned|using|virtual|void|volatile|wchar_t|while)\\b)\\w+",
                    ),
                    grammar.rule(
                      "class-name",
                      "\\b[A-Z]\\w*(?=\\s*::\\s*\\w+\\s*\\()",
    ...
    grammar.greedy_rule("string", "R\"([^()\\\\ ]{0,16})\\([\\s\\S]*?\\)\\1\""),
    grammar.greedy_rule(
      "string",
      "\"(?:\\\\(?:\\r\\n|[\\s\\S])|[^\"\\\\\\r\\n])*\"",
    ),
