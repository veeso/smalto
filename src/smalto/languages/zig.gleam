...
fn rules() -> List(Rule) {
  [
    ...
    grammar.rule(
      "label",
      "(?:\\b(?:break|continue)\\s*:\\s*)\\K\\w+\\b|\\b(?!\\d)\\w+\\b(?=\\s*:\\s*(?:\\{|while\\b))",
    ),
    grammar.rule(
      "class-name",
